//
// TBATeamEventStatusRankRanking.swift
//
...
open class TBATeamEventStatusRankRanking: Codable {
    ...
    public init(dq: Int?, matchesPlayed: Int?, qualAverage: Double?, rank: Int?, record: TBAWLTRecord?, sortOrders: [Double]?, teamKey: String?) {
        self.dq = dq
