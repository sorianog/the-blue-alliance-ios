...
open class TBATeamEventStatus: Codable {

    public var qual: TBATeamEventStatusRank?
    public var alliance: TBATeamEventStatusAlliance?
    public var playoff: TBATeamEventStatusPlayoff?
    ...
    public init(qual: TBATeamEventStatusRank?, alliance: TBATeamEventStatusAlliance?, playoff: TBATeamEventStatusPlayoff?, allianceStatusStr: String?, playoffStatusStr: String?, overallStatusStr: String?, nextMatchKey: String?, lastMatchKey: String?) {
        self.qual = qual
    ...
    public required init(from decoder: Decoder) throws {
        ...
        qual = try container.decodeIfPresent(TBATeamEventStatusRank.self, forKey: "qual")
        alliance = try container.decodeIfPresent(TBATeamEventStatusAlliance.self, forKey: "alliance")
        playoff = try container.decodeIfPresent(TBATeamEventStatusPlayoff.self, forKey: "playoff")
