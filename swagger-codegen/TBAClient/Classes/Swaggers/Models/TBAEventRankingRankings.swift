...
open class TBAEventRankingRankings: Codable {
    ...
    public init(dq: Int, matchesPlayed: Int, qualAverage: Int?, rank: Int, record: TBAWLTRecord, extraStats: [Double]?, sortOrders: [Double]?, teamKey: String) {
        self.dq = dq
    ...
    public required init(from decoder: Decoder) throws {
        ...
        record = try container.decode(TBAWLTRecord.self, forKey: "record")
