...
open class TBAEvent: Codable {
    ...
    public var district: TBADistrictList?
    ...
    public required init(from decoder: Decoder) throws {
        ...
        district = try container.decodeIfPresent(TBADistrictList.self, forKey: "district")
        ...
        webcasts = try container.decodeIfPresent([TBAWebcast].self, forKey: "webcasts")
