...
open class TBAMedia: Codable {

    public enum TBAType: String, Codable { 
    ...
    public init(key: String, type: TBAType, foreignKey: String?, details: Any?, preferred: Bool?) {
        self.key = key
        self.type = type
    ...
    public required init(from decoder: Decoder) throws {
        ...
        type = try container.decode(TBAType.self, forKey: "type")
