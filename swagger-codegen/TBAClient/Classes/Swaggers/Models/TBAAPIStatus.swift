...
open class TBAAPIStatus: Codable {
    ...
    public var ios: TBAAPIStatusAppVersion
    public var android: TBAAPIStatusAppVersion


    
    public init(currentSeason: Int, maxSeason: Int, isDatafeedDown: Bool, downEvents: [String], ios: TBAAPIStatusAppVersion, android: TBAAPIStatusAppVersion) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        ios = try container.decode(TBAAPIStatusAppVersion.self, forKey: "ios")
        android = try container.decode(TBAAPIStatusAppVersion.self, forKey: "android")
    }
}
