//
// TBAEliminationAllianceStatus.swift
//
...
open class TBAEliminationAllianceStatus: Codable {
    ...
    public init(currentLevelRecord: TBAWLTRecord?, level: String?, playoffAverage: Double?, record: TBAWLTRecord?, status: String?) {
