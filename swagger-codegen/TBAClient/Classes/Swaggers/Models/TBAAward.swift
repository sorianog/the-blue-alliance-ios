...
open class TBAAward: Codable {
    ...
    public var recipientList: [TBAAwardRecipient]
    /** The year this award was won. */
    public var year: Int


    
    public init(name: String, awardType: Int, eventKey: String, recipientList: [TBAAwardRecipient], year: Int) {
        self.name = name
    ...
    public required init(from decoder: Decoder) throws {
        ...
        recipientList = try container.decode([TBAAwardRecipient].self, forKey: "recipient_list")
