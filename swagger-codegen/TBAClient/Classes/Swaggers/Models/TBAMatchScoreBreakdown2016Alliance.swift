//
// TBAMatchScoreBreakdown2016Alliance.swift
//
...
open class TBAMatchScoreBreakdown2016Alliance: Codable {

    public enum TBARobot1Auto: String, Codable { 
        case crossed = "Crossed"
        case reached = "Reached"
        case _none = "None"
    }
    public enum TBARobot2Auto: String, Codable { 
        case crossed = "Crossed"
        case reached = "Reached"
        case _none = "None"
    }
    public enum TBARobot3Auto: String, Codable { 
        case crossed = "Crossed"
        case reached = "Reached"
        case _none = "None"
    }
    ...
    public var robot1Auto: TBARobot1Auto?
    public var robot2Auto: TBARobot2Auto?
    public var robot3Auto: TBARobot3Auto?
    ...
    public init(autoPoints: Int?, teleopPoints: Int?, breachPoints: Int?, foulPoints: Int?, capturePoints: Int?, adjustPoints: Int?, totalPoints: Int?, robot1Auto: TBARobot1Auto?, robot2Auto: TBARobot2Auto?, robot3Auto: TBARobot3Auto?, autoReachPoints: Int?, autoCrossingPoints: Int?, autoBouldersLow: Int?, autoBouldersHigh: Int?, autoBoulderPoints: Int?, teleopCrossingPoints: Int?, teleopBouldersLow: Int?, teleopBouldersHigh: Int?, teleopBoulderPoints: Int?, teleopDefensesBreached: Bool?, teleopChallengePoints: Int?, teleopScalePoints: Int?, teleopTowerCaptured: Int?, towerFaceA: String?, towerFaceB: String?, towerFaceC: String?, towerEndStrength: Int?, techFoulCount: Int?, foulCount: Int?, position2: String?, position3: String?, position4: String?, position5: String?, position1crossings: Int?, position2crossings: Int?, position3crossings: Int?, position4crossings: Int?, position5crossings: Int?) {
    ...
    public required init(from decoder: Decoder) throws {
        ...
        robot1Auto = try container.decodeIfPresent(TBARobot1Auto.self, forKey: "robot1Auto")
        robot2Auto = try container.decodeIfPresent(TBARobot2Auto.self, forKey: "robot2Auto")
        robot3Auto = try container.decodeIfPresent(TBARobot3Auto.self, forKey: "robot3Auto")
