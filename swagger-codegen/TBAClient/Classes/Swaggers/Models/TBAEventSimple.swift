...
open class TBAEventSimple: Codable {
    ...
    public init(key: String, name: String, eventCode: String, eventType: Int, district: TBADistrictList?, city: String?, stateProv: String?, country: String?, startDate: Date, endDate: Date, year: Int) {
        self.key = key
        self.name = name
