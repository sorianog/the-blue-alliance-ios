...
open class DistrictAPI {
  ...
  "key" : "key"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDistrictsByYear(year: Int, ifModifiedSince: String? = nil, completion: @escaping ((_ data: [TBADistrictList]?,_ error: Error?) -> Void)) {
  ...
  "key" : "key"
     ...
     */
    open class func getDistrictsByYearWithRequestBuilder(year: Int, ifModifiedSince: String? = nil) -> RequestBuilder<[TBADistrictList]> {
