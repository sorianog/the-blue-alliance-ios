...
open class MatchAPI {
  ...
  "match_number" : 6
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMatch(matchKey: String, ifModifiedSince: String? = nil, completion: @escaping ((_ data: TBAMatch?,_ error: Error?) -> Void)) {
  ...
  "event_key" : "event_key"
     ...
     - returns: RequestBuilder<TBAMatch> 
     */
    open class func getMatchWithRequestBuilder(matchKey: String, ifModifiedSince: String? = nil) -> RequestBuilder<TBAMatch> {
        var path = "/match/{match_key}"
        path = path.replacingOccurrences(of: "{match_key}", with: "\(matchKey)", options: .literal, range: nil)
        let URLString = TBAClientAPI.basePath + path
        let parameters: [String:Any]? = nil
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMatchSimple(matchKey: String, ifModifiedSince: String? = nil, completion: @escaping ((_ data: TBAMatchSimple?,_ error: Error?) -> Void)) {
  ...
  "match_number" : 6
     ...
     - returns: RequestBuilder<TBAMatchSimple> 
     */
    open class func getMatchSimpleWithRequestBuilder(matchKey: String, ifModifiedSince: String? = nil) -> RequestBuilder<TBAMatchSimple> {
